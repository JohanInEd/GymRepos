export const roleConfig = {
  owner: {
    ...
    permissions: ["finance", "analytics", "clients", "checkin", "membership", "progress", "classes", "operations", "setup", "users"],
  },
  admin: {
    label: "Administrador",
    description: "Gestion operativa, financiera, comercial y seguimiento de clientes.",
    permissions: ["finance", "analytics", "clients", "checkin", "membership", "progress", "classes", "operations", "setup"],
  },
  reception: {
    label: "Recepcion",
